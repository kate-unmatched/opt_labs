...
public class TestLab2 {
    ...
    public void checkExceptionDichotomy(){
        ...
        Assert.assertThrows(MismatchLengthVectorsException.class,
                () -> Lab2.dichotomyVector(function, left, right, 1E-2, 100));
    }
    @Test
    public void checkEfficiencyDichotomyVector(){
        ...
        RealVector misa = Lab2.dichotomyVector(function, left, right, 1E-5, 100);
        long endTime = System.currentTimeMillis();
        System.out.println("Working time of the Dichotomy > " + new DecimalFormat("#0.0000")
                .format((endTime - startTime)/1000.));

        RealVector kira = Lab2.dichotomyVector(function, left, right, 1E-5, MIDDLE);
        RealVector ryuk = Lab2.dichotomyVector(function, left, right, MIDDLE, LOW);
    ...
    public void checkEfficiencyGoldenRatioVector(){
        ...
        long startTime = System.currentTimeMillis();
        RealVector result1 = Lab2.goldenRatioVector(function, left, right, 1E-5, 100);
        long endTime = System.currentTimeMillis();
        System.out.println("Working time of the GoldenRatio > " + new DecimalFormat("#0.0000")
                .format((endTime - startTime)/1000.));

        RealVector result2 = Lab2.goldenRatioVector(function, left, right, 1E-5, MIDDLE);
        RealVector result3 = Lab2.goldenRatioVector(function, left, right, MIDDLE, LOW);
    ...
    public void checkEfficiencyFibonacciVector(){
        ...
        long startTime = System.currentTimeMillis();
        RealVector result1 = Lab2.fibonacciVector(function, left, right, 1E-5);
        long endTime = System.currentTimeMillis();
        System.out.println("Working time of the Fibonacci > " + new DecimalFormat("#0.000")
                .format((endTime - startTime)/1000.));

        RealVector result2 = Lab2.fibonacciVector(function, left, right, MIDDLE);
    ...
    public void checkEfficiencyPerCordDescend(){
        ...
        long startTime = System.currentTimeMillis();
        RealVector result1 = Lab2.perCordDescend(function, xStart,1E-5, 100);
        long endTime = System.currentTimeMillis();
        System.out.println("Working time of the PerCordDescend > " + new DecimalFormat("#0.0000")
                .format((endTime - startTime)/1000.));

        RealVector result2 = Lab2.perCordDescend(function, xStart,1E-5, MIDDLE);
        RealVector result3 = Lab2.perCordDescend(function, xStart,MIDDLE, LOW);
    ...
    public void checkPerCordDescend16(){
        ...
        RealVector result = Lab2.perCordDescend(function, xStart,1E-5, 100);
