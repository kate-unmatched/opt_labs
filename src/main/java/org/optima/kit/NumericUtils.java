...
public class NumericUtils
{
    ...
    public static final FunctionTUnary<DoubleVector> testFunc2d = NumericUtils::_testFunc2D;

    public static final FunctionTUnary<DoubleVector> testFuncNd = NumericUtils::_testFuncND;
    ...
    public static double _testFunc2D(DoubleVector x) {
